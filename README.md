...
![Screenshot of the Github icon before and after the solution.](/before-after.jpg)
...
`git clone https://github.com/Rewzer/Github-Bookmark-Redirect.git`

- Go into the project directory:
`cd Github-Bookmark-Redirect`

> You can move the project folder wherever you want.
